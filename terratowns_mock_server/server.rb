...
# This is a global variable for development server, especailly in our case; 
# This will persist in all instances.
# However, This should not be used for the production server.
$home = {}
